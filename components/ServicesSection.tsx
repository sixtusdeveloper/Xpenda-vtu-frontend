...
const services = [
  {
    ...
    icon: (
      <PhoneIcon className="w-12 h-12 p-2 shadow-lg overflow-hidden rounded-full bg-secondary dark:bg-gray-800" />
    ),
  ...
  },
  {
    ...
    icon: (
      <ZapIcon className="w-12 h-12 p-2 shadow-lg overflow-hidden rounded-full bg-secondary dark:bg-gray-800" />
    ),
    bg: "bg-secondary dark:bg-gray-900 shadow-lg rounded-md",
  },
  {
    ...
    icon: (
      <TvIcon className="w-12 h-12 p-2 shadow-lg overflow-hidden rounded-full bg-secondary dark:bg-gray-800" />
    ),
    bg: "bg-secondary dark:bg-gray-900 shadow-lg rounded-md",
  },
  {
    ...
    icon: (
      <DollarSignIcon className="w-12 h-12 p-2 shadow-lg overflow-hidden rounded-full bg-secondary dark:bg-gray-800" />
    ),
    bg: "bg-secondary dark:bg-gray-900 shadow-lg rounded-md",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-6 text-left md:text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className={`p-6 rounded-lg shadow-lg text-center transition-transform transform hover:scale-105 ${service.bg}`}
            >
