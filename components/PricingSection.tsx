  ...
  return (
    <section id="pricing" className="relative py-10 md:py-20 bg-secondary">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mt-10">
          <Link href="/pricing">
            <Button className="bg-gradient-to-r from-yellow-500 via-pink-500 to-purple-600 hover:bg-yellow-600 text-white font-semibold text-base h-12 px-6 py-3 rounded-lg shadow-lg">
              See All Pricing
            </Button>
          </Link>
        </div>
